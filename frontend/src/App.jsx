      ...
      <div style={{ display: "flex" }}>
        ...
        <main style={{ flexGrow: 1, padding: "24px" }}>
          <Routes>
            ...
            {/* <Route path="/admin/categories" element={<ServiceCategoryMgmt />} />
            <Route path="/admin/orders" element={<OrdersPanel />} />
            <Route path="/admin/disputes" element={<DisputeResolution />} />
            <Route path="/admin/reports" element={<ReportsAnalytics />} />
            <Route path="/admin/promotions" element={<PromoCampaignForm />} />
            <Route path="/admin/cross-sell" element={<CrossSellManager />} />
            <Route
            ...
            />
            <Route path="/admin/bnpl-approval" element={<BNPLApproval />} />
